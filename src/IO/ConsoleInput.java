...
public class ConsoleInput {
    ...
    public static String moveInput() {
        ...
        if(input.charAt(0)>=97 && input.charAt(0)<=122 && input.charAt(1)>=48 && input.charAt(1)<=55){
            return input;
        }
        if(input.charAt(1)>=97 && input.charAt(1)<=122 && input.charAt(0)>=48 && input.charAt(0)<=55){
